...
export function Navbar() {
	return (
		<header className="fixed top-0 left-0 z-20 flex w-full items-center justify-between bg-radial from-transparent from-[1px] via-white to-[3px] bg-[size:3px_3px] px-4 py-2 text-black backdrop-blur-[4px] sm:px-10 md:px-14 lg:px-20 xl:px-24 dark:bg-neutral-950/80 dark:via-neutral-950 dark:text-white">
