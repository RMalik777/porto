...
export function Footer() {
	...
	return (
		<StarsBackground
			factor={0.05}
			speed={10}
			starColor={resolvedTheme === "dark" ? "#8e51ff" : "#7f22fe"}
			className="bg-[radial-gradient(ellipse_at_bottom,#fff_100%,#f5f5f5_0%)] dark:bg-[radial-gradient(ellipse_at_bottom,#0a0a0a_100%,#262626_0%)]"
		>
