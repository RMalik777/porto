		...
		<main className="mt-2 flex h-dvh min-h-dvh w-full flex-col items-center justify-center gap-8 tracking-tight sm:mt-4">
			<Grid>
				<section className="flex w-full flex-col items-center justify-center gap-4 text-center leading-none">
					<h1 className="bg-linear-to-r/oklch from-violet-500 to-fuchsia-500 bg-clip-text text-center font-mono text-5xl font-semibold tracking-tighter text-transparent duration-200 ease-out sm:text-6xl md:text-7xl lg:text-8xl xl:text-9xl">
						404
					</h1>
