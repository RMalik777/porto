    ...
    <main>
      <div className=" h-screen flex flex-col items-center justify-center gap-8">
        <div className="flex flex-col md:flex-row items-center gap-4">
          ...
          <div className="verticalLine w-1/2 md:w-0 md:h-full rounded-sm border-solid border-l-0 border-b-4 md:border-l-4 md:border-b-0 border-black">

          </div>
          <h2 className="subtitle text-center font-medium">It&apos;s look like you are lost</h2>
        </div>
        <button className="defaultbtn rounded-full px-8 py-3 transition-all duration-300 ease-out"><Link href="/">Back to Home</Link></button>
      </div>
