  ...
  return (
    <main style={{ height: "200vh" }}>
      <div id="intro" className=" h-screen flex flex-col items-center justify-center">
        ...
        <Link href="#content">
          <button className="contactbtn rounded-full px-8 py-3">Let&apos;s Get Started</button>
        </Link>
      </div>
      ...
      <div id="content" className="h-auto md:h-screen grid md:grid-cols-2 grid-cols-1 md:grid-rows-2 grid-rows-3 justify-center md:justify-evenly items-center py-4 mb-12 md:mb-6 gap-4 md:gap-12">
        ...
        <Link href="/Contact" className="md:col-start-2 self-start justify-self-center w-1/2">
          <button className="contactbtn rounded-full px-8 py-3">Contact Me</button>
        </Link>
      </div>
    </main>
  )
